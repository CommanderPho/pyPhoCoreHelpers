...
Welcome to ``pyPhoCoreHelpers`` contributor's guide.
...
If you experience bugs or general issues with ``pyPhoCoreHelpers``, please have a look
...
You can help improve ``pyPhoCoreHelpers`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``pyPhoCoreHelpers`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``pyPhoCoreHelpers``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n pyPhoCoreHelpers python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/pyPhoCoreHelpers.git
    cd pyPhoCoreHelpers
...
#. Install |pre-commit|_::
   ...
   ``pyPhoCoreHelpers`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/pyPhoCoreHelpers
.. _issue tracker: https://github.com/<USERNAME>/pyPhoCoreHelpers/issues
.. <-- end -->
