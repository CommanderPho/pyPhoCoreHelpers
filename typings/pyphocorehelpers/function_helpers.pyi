...
This type stub file was generated by pyright.
"""
def compose_functions(*args, progress_logger=..., error_logger=...):
...
def compose_functions_with_error_handling(*args, progress_logger=..., error_logger=...):
    """ Composes n functions passed as input arguments into a single lambda function efficienctly.
    right-to-left ordering (default): compose(f1, f2, ..., fn) == lambda x: f1(...(f2(fn(x))...)
    # OLD: left-to-right ordering: compose(f1, f2, ..., fn) == lambda x: fn(...(f2(f1(x))...)
    Note that functions are composed from right-to-left, meaning that the first function input is the outermost function
...
def global_function(is_global: bool = ...):
...
def function_attributes(short_name=..., tags=..., creation_date=..., input_requires=..., output_provides=..., uses=..., used_by=..., related_items=..., conforms_to=..., is_global: bool = ..., validate_computation_test: Optional[Callable] = ..., requires_global_keys=..., provides_global_keys=...):
