...
def safe_get_if_not_None(a_list: Optional[List], index: int, fallback_value: Any): # -> Any:
...
def reorder_keys_relative(a_dict: Dict, key_names: List[str], relative_mode=...) -> Dict:
    """Reorders specified keys in a Dict while preserving other keys.
