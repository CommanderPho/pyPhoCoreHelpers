...
def array_repr_with_graphical_preview(ip: ipykernel.zmqshell.ZMQInteractiveShell, include_shape: bool = ..., horizontal_layout: bool = ..., include_plaintext_repr: bool = ..., height: int = ..., width: Optional[int] = ...) -> ipykernel.zmqshell.ZMQInteractiveShell:
