...
class CodeConversion:
    ...
    @classmethod
    def convert_type_to_typehint_string(cls, target_class_str: str, use_relative_types: bool = ...) -> Tuple[str, Optional[str]]:
    ...
    @classmethod
    def get_dict_typehint_string(cls, a_dict: Dict, use_relative_types: bool = ...) -> str:
    ...
    @classmethod
    def get_tuple_typehint_string(cls, a_tuple: Tuple, use_relative_types: bool = ...) -> str:
...
def get_running_python(debug_print: bool = ...): # -> tuple[Path, Path, Path]:
...
def get_python_environment(active_venv_path: Path, debug_print: bool = ...): # -> tuple[Path, Path, Path]:
    """
