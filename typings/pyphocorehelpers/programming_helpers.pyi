...
def metadata_attributes(short_name=..., tags=..., creation_date=..., input_requires=..., output_provides=..., uses=..., used_by=..., related_items=..., pyqt_signals_emitted=...):
...
def build_metadata_property_reverse_search_map(a_fn_dict, a_metadata_property_name=...):
...
def copy_to_clipboard(code_str: str, message_print=...):
    ...
...
class CodeParsers:
    ...
    @classmethod
    def convert_to_kwarg_passthrough(cls, input_str, post_equals_space: bool = ..., to_clipboard=...):
        """
...
class IPythonHelpers:
    ...
    @classmethod
    def cell_vars(cls, get_globals_fn=..., offset=...):
...
class CodeConversion:
    ...
    @classmethod
    def convert_dictionary_to_defn_lines(cls, target_dict, multiline_assignment_code=..., dictionary_name: str = ..., include_comment: bool = ..., copy_to_clipboard=..., output_variable_prefix=...):
    ...
    @classmethod
    def extract_undefined_variable_names_from_code(cls, code_dict_defn: str, max_iterations_before_abort: int = ..., debug_print=...):
    ...
    @classmethod
    def build_dummy_dictionary_from_defn_code(cls, code_dict_defn: str, max_iterations_before_abort: int = ..., missing_variable_values=..., debug_print=...):
    ...
    @classmethod
    def convert_defn_lines_to_dictionary(cls, code, multiline_dict_defn=..., multiline_members_indent=...):
